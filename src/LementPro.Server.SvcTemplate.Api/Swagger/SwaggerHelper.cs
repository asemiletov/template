        ...
        public static void ConfigureSwaggerGen(SwaggerGenOptions swaggerGenOptions)
        {
            foreach (var doc in Configuration)
            {
                ...
                doc.Sections?.ToList().ForEach(section =>
                    swaggerGenOptions.SwaggerDoc($"{section.Name}", new OpenApiInfo()
                    {
            ...
            swaggerGenOptions.AddBearerAuthorization();
            //swaggerGenOptions.DescribeAllEnumsAsStrings();
        }

        private static void AddBearerAuthorization(this SwaggerGenOptions swaggerGenOptions)
        {
